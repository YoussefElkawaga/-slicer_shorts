...
class LLMClient:
    ...
    def call(self, prompt: str, input_data: Any = None) -> str:
        ...
        Returns:
            模型响应文本
        """
        prompt = "[CRITICAL DIRECTIVE: You are an English-only AI. You MUST generate ALL responses, JSON values, titles, descriptions, and outlines entirely in English. If the input or examples are in Chinese, translate them and output ONLY in English.]\n\n" + prompt
        try:
