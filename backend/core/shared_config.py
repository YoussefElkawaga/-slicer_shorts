...
# Shorts duration presets — user-selectable target clip lengths
SHORTS_DURATION_PRESETS = {
    "ultra_short": {
        "label": "⚡ < 30s",
        "min_seconds": 15,
        "max_seconds": 35,
        "target_seconds": 25,
        "description": "Ultra-short TikTok/Reels"
    },
    "short": {
        "label": "🎬 30s - 60s",
        "min_seconds": 25,
        "max_seconds": 70,
        "target_seconds": 45,
        "description": "Classic YouTube Shorts"
    },
    "medium": {
        "label": "📺 1 - 2 min",
        "min_seconds": 50,
    ...
    "long": {
        ...
        "max_seconds": 200,
        "target_seconds": 150,
        "description": "Mini-clips"
    },
}
DEFAULT_SHORTS_DURATION_PRESET = "short"  # 30s-60s classic YouTube Shorts
